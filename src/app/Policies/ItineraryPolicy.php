...
class ItineraryPolicy
{
    ...
    {
        return $user->can('view_any_itinerary');
    }
    ...
    {
        return $user->can('view_itinerary');
    }
    ...
    {
        return $user->can('create_itinerary');
    }
    ...
    {
        return $user->can('update_itinerary');
    }
    ...
    {
        return $user->can('delete_itinerary');
    }
    ...
    {
        return $user->can('delete_any_itinerary');
    }
     ...
     */
    public function replicate(User $user, Itinerary $itinerary): bool
    {
